...
namespace TaskManagerApp.Infra.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    {
                        1,
                        new DateTime(2023, 4, 13, 20, 4, 15, 530, DateTimeKind.Local).AddTicks(
                            1513
                        ),
                        null,
                        null,
                    ...
                    },
                    {
                        ...
                        new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
        ...
        {
            migrationBuilder.DropTable(name: "GoalSteps");

            migrationBuilder.DropTable(name: "GoalTaskItems");

            migrationBuilder.DropTable(name: "ProfilePresetTaskItem");

            migrationBuilder.DropTable(name: "TaskItemNotes");

            migrationBuilder.DropTable(name: "TimesheetNotes");

            migrationBuilder.DropTable(name: "Goals");

            migrationBuilder.DropTable(name: "PresetTaskItems");

            migrationBuilder.DropTable(name: "Profiles");

            migrationBuilder.DropTable(name: "TaskItems");

            migrationBuilder.DropTable(name: "ProfileTypes");
